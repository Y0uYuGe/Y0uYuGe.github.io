...
migrated: true
permalink: /posts/csdn-139752095/
redirect_from:
  - "/en/CTF与Pwn/csdn-139752095/"
  - "/CTF与Pwn/csdn-139752095/"
---
...
![Image](/images/csdn/2024/csdn-139752095/image-001-1694889935.png)

![Image](/images/csdn/2024/csdn-139752095/image-002-a62969cd1a.png)
![Image](/images/csdn/2024/csdn-139752095/image-003-75072155fe.png)![Image](/images/csdn/2024/csdn-139752095/image-004-b36d1305cd.png)

core::slice::raw::from_raw_parts <core::slice::raw::from_raw_parts> does not allocate a heap chunk



![Image](/images/csdn/2024/csdn-139752095/image-005-a87011389b.png)
![Image](/images/csdn/2024/csdn-139752095/image-006-9a58dffe9a.png)
...
![Image](/images/csdn/2024/csdn-139752095/image-007-3c32a84f52.png)
...
# Code audit  
![Image](/images/csdn/2024/csdn-139752095/image-008-25d0b006fc.png)
...
![Image](/images/csdn/2024/csdn-139752095/image-009-708967f580.png)
...
Use pause to find the breakpoint of the corresponding function; the allocation performed by the final `    let mut recv_iov = [iovec {
        iov_base: vec![0u8; recv_size].as_mut_ptr() as *mut _,  //生命周期问题导致存在悬挂指针
        iov_len: recv_size,
    }];` should be at![Image](/images/csdn/2024/csdn-139752095/image-010-99f1791e7a.png)
...
![Image](/images/csdn/2024/csdn-139752095/image-011-066d8d4d59.png)


![Image](/images/csdn/2024/csdn-139752095/image-012-5d70b67b8a.png)
...
![Image](/images/csdn/2024/csdn-139752095/image-013-cdd38d69b7.png)
Then a normal free
The second allocation uses `__rust_alloc`, which corresponds to malloc
![Image](/images/csdn/2024/csdn-139752095/image-014-72cf723b0b.png)
...
![Image](/images/csdn/2024/csdn-139752095/image-015-0d9c9e5e15.png)
